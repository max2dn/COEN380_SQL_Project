...
def clean_h5_dictionary(input_dict):
    ...
    if (input_dict['artist_mbid'] == NULL):
        return l
    ...
    playmeid = r"\d{4}"
    if (input_dict['artist_playmeid'] == NULL):
        return l
    ...
    if (input_dict['release_7digitalid'] == NULL):
        return l
    elif not (isinstance(input_dict['release_7digitalid'], int)):
        return l

    if (input_dict['song_id'] == NULL):
        return l
    ...
    if (input_dict['track_7digitalid'] == NULL):
        return l
